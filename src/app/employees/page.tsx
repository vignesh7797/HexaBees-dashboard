            ...
            {showProfile && (
                <section className="p-4">
                    <div className="bg-white rounded-md p-4 w-full">
                        <button className={`border-0 p-2 aspect-square rounded-full text-2xl bg-white text-grey` } onClick={() => setShowProfile(false)}>
                            <IoArrowBack/>
                        </button>

                        <div className="mt-4 flex gap-8">
                            <div className="rounded-md w-52 h-52 p-2 flex justify-center items-center bg-slate-200 text-7xl text-slate-600">
                                <FaUser/>
                            </div>
                            <div>
                                <h1 className="text-4xl text-orange-500 font-adlm font-semibold">Prabesh</h1>
                                <p className="my-2 text-xl font-acme text-grey">+91 9042127018</p>
                                <p>4/448, Anna nagar, Chennai</p>
                            </div>
                        </div>
                    </div>
                </section>
